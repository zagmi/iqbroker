...
from iqbroker.http.login import Login
from iqbroker.http.loginv2 import Loginv2
from iqbroker.http.logout import Logout
from iqbroker.http.login2fa import Login2FA
from iqbroker.http.send_sms import SMS_Sender
from iqbroker.http.verify import Verify
from iqbroker.http.getprofile import Getprofile
from iqbroker.http.auth import Auth
from iqbroker.http.token import Token
from iqbroker.http.appinit import Appinit
from iqbroker.http.billing import Billing
from iqbroker.http.buyback import Buyback
from iqbroker.http.changebalance import Changebalance
from iqbroker.http.events import Events
from iqbroker.ws.client import WebsocketClient
from iqbroker.ws.chanels.get_balances import *

from iqbroker.ws.chanels.ssid import Ssid
from iqbroker.ws.chanels.subscribe import *
from iqbroker.ws.chanels.unsubscribe import *
from iqbroker.ws.chanels.setactives import SetActives
from iqbroker.ws.chanels.candles import GetCandles
from iqbroker.ws.chanels.buyv2 import Buyv2
from iqbroker.ws.chanels.buyv3 import *
from iqbroker.ws.chanels.user import *
from iqbroker.ws.chanels.api_game_betinfo import Game_betinfo
from iqbroker.ws.chanels.instruments import Get_instruments
from iqbroker.ws.chanels.get_financial_information import GetFinancialInformation
from iqbroker.ws.chanels.strike_list import Strike_list
from iqbroker.ws.chanels.leaderboard import Leader_Board

from iqbroker.ws.chanels.traders_mood import Traders_mood_subscribe
from iqbroker.ws.chanels.traders_mood import Traders_mood_unsubscribe
from iqbroker.ws.chanels.technical_indicators import Technical_indicators
from iqbroker.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from iqbroker.ws.chanels.get_order import Get_order
from iqbroker.ws.chanels.get_deferred_orders import GetDeferredOrders
from iqbroker.ws.chanels.get_positions import *

from iqbroker.ws.chanels.get_available_leverages import Get_available_leverages
from iqbroker.ws.chanels.cancel_order import Cancel_order
from iqbroker.ws.chanels.close_position import Close_position
from iqbroker.ws.chanels.get_overnight_fee import Get_overnight_fee
from iqbroker.ws.chanels.heartbeat import Heartbeat


from iqbroker.ws.chanels.digital_option import *
from iqbroker.ws.chanels.api_game_getoptions import *
from iqbroker.ws.chanels.sell_option import Sell_Option
from iqbroker.ws.chanels.sell_digital_option import Sell_Digital_Option
from iqbroker.ws.chanels.change_tpsl import Change_Tpsl
from iqbroker.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from iqbroker.ws.objects.timesync import TimeSync
from iqbroker.ws.objects.profile import Profile
from iqbroker.ws.objects.candles import Candles
from iqbroker.ws.objects.listinfodata import ListInfoData
from iqbroker.ws.objects.betinfo import Game_betinfo_data
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <iqbroker.http.resource.Resource>`.
    ...
    def login_2fa(self):
        ...
        :returns: The instance of :class:`Login2FA
            <iqbroker.http.login2fa.Login2FA>`.
        """
    ...
    def send_sms_code(self):
        ...
        :returns: The instance of :class:`SMS_Sender
            <iqbroker.http.send_sms.SMS_Sender>`.
        """
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <iqbroker.http.changebalance.Changebalance>`.
        """
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <iqbroker.http.getprofile.Getprofile>`.
        """
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <iqbroker.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <iqbroker.ws.chanels.unsubscribe.Unsubscribe>`.
        """
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <iqbroker.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <iqbroker.ws.chanels.candles.GetCandles>`.
        """
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <iqbroker.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
