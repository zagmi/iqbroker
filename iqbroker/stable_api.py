...
import iqbroker.country_id as Country
import threading
import time
import json
import logging
...
from iqbroker.expiration import get_expiration_time, get_remaning_time
...
class IQ_Option:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = IQOptionAPI(
            "iqoption.com", "ws.iqoption.com", self.email, self.password
        )
        check = None
    ...
    def check_win_v2(self, id_number, polling_time):
        ...
        # Function by kkagill ( https://github.com/Lu-Yi-Hsun/iqbroker/issues/196 | https://github.com/kkagill )
    ...
    # thank thiagottjv
    # https://github.com/Lu-Yi-Hsun/iqbroker/issues/65#issuecomment-513998357
